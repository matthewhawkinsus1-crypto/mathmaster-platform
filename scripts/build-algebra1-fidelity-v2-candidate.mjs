...
console.log('\nNext commands:');
console.log(`  node scripts/verify-path-drafts.mjs ${OUTPUT}`);
console.log('  node scripts/audit-algebra1-cognitive-fidelity-v2.mjs   # after temporarily pointing audit input to candidate or promotion');
console.log('  node scripts/audit-algebra1-semantic-fidelity-v2.mjs    # same');
