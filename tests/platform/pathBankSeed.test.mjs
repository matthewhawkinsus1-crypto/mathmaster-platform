...
// Counted from the CCMR V2.1 production release, which is the current shape of
// these banks. The previous numbers here (SAT 1,672 / ACT 1,800 / TSIA2 1,800)
// described the pre-V2.1 Fidelity V2 banks that covered the whole TEKS surface.
// V2.1 narrowed each bank to the standards its exam actually assesses and is
// regenerated by scripts/build-ccmr-v2-1-production-release.mjs, so drift in
// these totals is caught there as well as here.
//
