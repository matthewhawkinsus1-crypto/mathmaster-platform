...
test('focused Assignment V5 deploy updates Hosting and only the Assignment AI callable', () => {
  assert.match(script, /firebase deploy --only hosting,functions:authorAssignmentWithAI/);
