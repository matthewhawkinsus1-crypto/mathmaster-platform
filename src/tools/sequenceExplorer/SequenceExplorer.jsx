...
export default function SequenceExplorer({ questionData = {}, onAction }) {
  ...
  if (mode === 'ruleBridge') return <RuleBridge questionData={questionData} feedback={feedback} submit={submit} />;
  if (mode === 'missingTerm') return <MissingTerm questionData={questionData} feedback={feedback} submit={submit} />;
  if (mode === 'partialSum') return <PartialSum questionData={questionData} feedback={feedback} submit={submit} />;
  if (mode === 'compare') return <CompareSequences questionData={questionData} feedback={feedback} submit={submit} />;
  return <AnalyzeSequence questionData={questionData} feedback={feedback} submit={submit} />;
}

function AnalyzeSequence({ questionData, feedback, submit }) {
...
function RuleBridge({ questionData, feedback, submit }) {
  const spec = sequenceFromQuestion(questionData);
...
function MissingTerm({ questionData, feedback, submit }) {
  const spec = sequenceFromQuestion(questionData);
...
function PartialSum({ questionData, feedback, submit }) {
  const spec = sequenceFromQuestion(questionData);
...
function CompareSequences({ questionData, feedback, submit }) {
