...
export default function TransformationsLab({ questionData = {}, onAction }) {
  ...
  const [reflection, setReflection] = usePersistentToolState('reflection', '');
  const [scaleKind, setScaleKind] = usePersistentToolState('scaleKind', '');
  const [scaleFactor, setScaleFactor] = usePersistentToolState('scaleFactor', '');
  const [horizontalReflection, setHorizontalReflection] = usePersistentToolState('horizontalReflection', '');
  const [horizontalScaleKind, setHorizontalScaleKind] = usePersistentToolState('horizontalScaleKind', '');
  const [horizontalScaleFactor, setHorizontalScaleFactor] = usePersistentToolState('horizontalScaleFactor', '');
  const [horizontalDirection, setHorizontalDirection] = usePersistentToolState('horizontalDirection', '');
  const [horizontalDistance, setHorizontalDistance] = usePersistentToolState('horizontalDistance', '');
  const [verticalDirection, setVerticalDirection] = usePersistentToolState('verticalDirection', '');
  const [verticalDistance, setVerticalDistance] = usePersistentToolState('verticalDistance', '');
