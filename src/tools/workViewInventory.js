...
export const WORK_VIEW_INVENTORY = Object.freeze({
  dataModelingLab: { status: 'migrated', stage: '1-2', capabilities: ['undo', 'fitView', 'panZoom', 'pointEditing', 'numericControls', 'equationInput', 'tableData', 'task', 'help', 'primaryActions'] },
  ...
  inverseCompositionLab: { status: 'migrated', stage: '3D', capabilities: ['undo', 'numericControls', 'equationInput', 'instruction', 'task', 'help', 'primaryActions'] },
  functionOperationsLab: { status: 'migrated', stage: '3D', capabilities: ['undo', 'numericControls', 'equationInput', 'tableData', 'instruction', 'task', 'help', 'primaryActions'] },
  parabolaGeometryLab: { status: 'migrated', stage: '3D', capabilities: ['undo', 'fitView', 'panZoom', 'pointEditing', 'numericControls', 'equationInput', 'instruction', 'task', 'help', 'primaryActions'] },
  polynomialWorkshop: { status: 'migrated', stage: '3D', capabilities: ['undo', 'fitView', 'panZoom', 'numericControls', 'equationInput', 'instruction', 'task', 'help', 'primaryActions'] },
  signSolutionAnalyzer: { status: 'migrated', stage: '3D', capabilities: ['undo', 'numericControls', 'equationInput', 'tableData', 'instruction', 'task', 'help', 'primaryActions'] },
  complexPlaneLab: { status: 'migrated', stage: '3D', capabilities: ['undo', 'fitView', 'panZoom', 'pointEditing', 'numericControls', 'equationInput', 'instruction', 'task', 'help', 'primaryActions'] },
  exponentialLogBridge: { status: 'migrated', stage: '3D', capabilities: ['undo', 'fitView', 'panZoom', 'numericControls', 'equationInput', 'tableData', 'instruction', 'task', 'help', 'primaryActions'] },
  representationMatch: { status: 'migrated', stage: '3D', capabilities: ['undo', 'numericControls', 'tableData', 'instruction', 'task', 'help', 'primaryActions'] },
  ...
  openSortBoard: { status: 'migrated', stage: '3D', capabilities: ['undo', 'pointEditing', 'instruction', 'task', 'help', 'primaryActions', 'secondaryActions'] },
