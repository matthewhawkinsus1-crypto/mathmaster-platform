...
export const buildAuthoringContract = ({ generatedAt = new Date(), courseId = null } = {}) => [
  ...
  '- Pure finite-choice questions are ONE ATTEMPT per generated version. In Warm-Up/Classwork/Practice, a missed choice item may offer a fresh replacement when that section allows replacement; DOL/Quiz/Test remain one-and-done.',
