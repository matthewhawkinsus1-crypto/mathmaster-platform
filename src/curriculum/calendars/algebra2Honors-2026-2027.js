...
export const ALGEBRA2_HONORS_2026_2027 = {
  ...
  windows: [
    ...
    { id: 'alg2h.u1.t1', parentId: 'alg2h.u1', curriculumType: 'topic', curriculumId: 'alg2.unit1.topic1', title: 'Topic 1', start: '2026-08-10', end: '2026-08-21' },
    { id: 'alg2h.u1.t2', parentId: 'alg2h.u1', curriculumType: 'topic', curriculumId: 'alg2.unit1.topic2', title: 'Topic 2', start: '2026-08-24', end: '2026-08-28' },
    ...
    { id: 'alg2h.u2.t1', parentId: 'alg2h.u2', curriculumType: 'topic', curriculumId: 'alg2.unit2.topic1', title: 'Topic 1', start: '2026-08-31', end: '2026-09-03' },
    { id: 'alg2h.u2.t2', parentId: 'alg2h.u2', curriculumType: 'topic', curriculumId: 'alg2.unit2.topic2', title: 'Topic 2', start: '2026-09-08', end: '2026-09-15' },
    ...
    // --- Unit 3: Systems ----------------------------------------------------
    { id: 'alg2h.u3', curriculumType: 'unit', curriculumId: 'alg2.unit3', title: 'Unit 3: Systems of Linear Equations and Inequalities', start: '2026-09-21', end: '2026-10-02' },
    ...
    { id: 'alg2h.u4.a', curriculumType: 'unit', curriculumId: 'alg2.unit4', title: 'Unit 4: Expressions, Factoring, Equations with Rational Exponents', start: '2026-10-05', end: '2026-10-08' },
    { id: 'alg2h.u4.b', curriculumType: 'unit', curriculumId: 'alg2.unit4', title: 'Unit 4 (continued)', start: '2026-10-19', end: '2026-10-23' },

    // --- Module 3: Analyzing Structure — TWO windows ------------------------
    { id: 'alg2h.m3.a', curriculumType: 'module', curriculumId: 'alg2.module3', title: 'Module 3: Analyzing Structure', start: '2026-10-26', end: '2026-10-27' },
    ...
    { id: 'alg2h.m3.b', curriculumType: 'module', curriculumId: 'alg2.module3', title: 'Module 3: Analyzing Structure (second window)', start: '2027-01-06', end: '2027-01-29' },

    // --- Module 4: Extending Beyond Polynomials — TWO windows ---------------
    { id: 'alg2h.m4.a', curriculumType: 'module', curriculumId: 'alg2.module4', title: 'Module 4: Extending Beyond Polynomials', start: '2026-11-02', end: '2026-11-20' },
    { id: 'alg2h.m4.b', curriculumType: 'module', curriculumId: 'alg2.module4', title: 'Module 4: Extending Beyond Polynomials (second window)', start: '2027-02-01', end: '2027-03-12' },

    // --- Module 5: Exponentials and Logarithmics — TWO windows --------------
    { id: 'alg2h.m5.a', curriculumType: 'module', curriculumId: 'alg2.module5', title: 'Module 5: Exploring Exponentials and Logarithmics', start: '2026-11-30', end: '2026-12-17' },
    { id: 'alg2h.m5.b', curriculumType: 'module', curriculumId: 'alg2.module5', title: 'Module 5: Exploring Exponentials and Logarithmics (second window)', start: '2027-03-22', end: '2027-04-09' },
    ...
    { id: 'alg2h.rev.m2', curriculumType: 'review', curriculumId: 'alg2.module2.review', title: 'Module 2 Review: Exploring Quadratic Functions', start: '2027-04-20', end: '2027-04-22', recommendationMode: 'review' },
