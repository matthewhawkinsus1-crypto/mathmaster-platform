...
export const buildAssignmentCreatorRequest = (input = {}, { generatedAt = new Date() } = {}) => {
  ...
  return [
    ...
    '- For a full Practice section of 5 or more questions, author the normal TEKS-aligned independent practice the lesson needs. Do NOT imitate SAT, ACT, TSIA2, or ASVAB wording merely to satisfy CCMR. MathMaster will source matching Practice items from the audited CCMR Fidelity V2.1 bank while preserving the same TEKS and the requested question count.',
