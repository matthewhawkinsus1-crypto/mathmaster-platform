...
export default function ChallengeDryRun({ courseId, standardCode, questionStyle = 'any', challengeMode = 'standard', solverRaceFocus = 'mixed', solverRaceDifficulty = 'ramp', roundCount, roundSeconds, timingMode = 'timed', title, onClose }) {
  ...
  const room = {
    ...
    title: title || 'Dry run',
    status: 'running',
    challengeMode: dryRun.challengeMode || challengeMode,
    solverRaceFocus: dryRun.solverRaceFocus || solverRaceFocus,
    solverRaceDifficulty: dryRun.solverRaceDifficulty || solverRaceDifficulty,
