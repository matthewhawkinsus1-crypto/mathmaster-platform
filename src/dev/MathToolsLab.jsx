...
export const SAMPLE_SPECS = {
  ...
  sequenceExplorer: { mode:'compare',studentActions:['plotSequence'],left:{kind:'arithmetic',first:5,difference:4},right:{kind:'geometric',first:1,ratio:2},compareN:7,leftLabel:'Arithmetic A',rightLabel:'Geometric B' },
  ...
  transformationsLab: { mode:'plotTransform',family:'linear',function:{type:'linear',a:1,h:2,k:-1},sourcePoints:[[-2,-2],[0,0],[2,2]],graphBounds:{xMin:-8,xMax:8,yMin:-8,yMax:8} },
