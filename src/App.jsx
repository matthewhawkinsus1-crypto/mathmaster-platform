...
const projectTeacherOverridesForDisplay = (
  ...
  ([assignmentId, assignmentTracker]) => {
    ...
    Object.entries(nextTracker).forEach(([questionIndex, record]) => {
      ...
      if (override?.active !== true || !Number.isFinite(Number(override.score))) return;
