...
// --- Where "weak" begins --------------------------------------------------------
//
// Lives here rather than in the recommendation engine because the shared
// remediation planner needs it and the recommendation engine is browser-only.
// The engine still exports it, so no caller had to change.
//
// Below this, a prerequisite is not merely shaky — it is the thing standing in
// the way, and descending to it is justified by evidence rather than by guess.
