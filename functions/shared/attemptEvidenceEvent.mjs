/*
 * EVIDENCE IS WRITTEN FROM A GRADING RESULT, AND THE SERVER PRODUCES ONE TOO.
 *
 * A deadline auto-submit grades the student's checkpointed response inside a
 * Cloud Function and must write the same evidence a manual Submit would have.
 * This file therefore lives in shared code; src/platform/history/evidenceEvent.js
 * re-exports it for every browser caller.
 */
import { normalizeQuestionInstructionalMetadata } from './questionMetadata.mjs';
